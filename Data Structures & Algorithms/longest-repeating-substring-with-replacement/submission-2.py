class Solution:
    def characterReplacement(self, s: str, k: int) -> int:
        ...
        l, r = 0, 0
        n = len(s)
        hash_map = {} # O(1) space because independent of n -> Capped at O(26)
        ...
        while r < n: # O(n)
            ...
            for c, cnt in hash_map.items(): # O(26) for worst case, since we only got 24 uppercase english characters
                if cnt > most_count:
                    most_count = cnt
                    most_char = c
